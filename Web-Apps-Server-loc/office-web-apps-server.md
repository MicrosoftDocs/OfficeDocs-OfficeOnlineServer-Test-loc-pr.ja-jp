---
title: Office Web Apps サーバー
TOCTitle: '@NoTitle'
ms:assetid: e75c9827-f5ce-4099-a08c-b42fde72ea98
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ219456(v=office.15)
ms:contentKeyID: 48796453
ms.date: 01/04/2018
...
![Office 2013 ロゴ](images/JJ219456.a106e261-2cd0-43b7-af77-92de7e4b6fb9(Office.15).png "Office 2013 ロゴ")SharePoint 2013 を使用する Office Web Apps サーバーと Office Web Appsに関する説明は、次の表に示す記事を参照してください。


### TechNet にある、SharePoint 2013 を使用する Office Web Apps サーバーと Office Web Apps の概要の記事
...
<tbody>
<tr class="odd">
<td><p><a href="deploy-the-infrastructure-office-web-apps-server.md">インフラストラクチャの展開: Office Web Apps サーバー</a></p></td>
<td><p>Office Web Apps サーバー が組織の内部設置型ホストに対してブラウザー ベースの Office 機能を提供する方法について説明します。</p></td>
</tr>
<tr class="even">
<td><p><a href="use-office-web-apps-with-sharepoint-2013.md">SharePoint 2013 で Office Web Apps を使用する</a></p></td>
<td><p>Office Web Apps　の新機能、および内部設置型展開で SharePoint Server 2013 と組み合わせて使用する方法について説明します。</p></td>
</tr>
<tr class="odd">
<td><p><a href="apply-software-updates-to-office-web-apps-server.md">Office Web Apps サーバーへのソフトウェアの更新プログラムの適用</a></p></td>
<td><p>Office Web Apps Server ファームにソフトウェアの更新プログラムを適用する方法について説明します。</p></td>
</tr>
</tbody>
</table>
...
<td><p>Office 2013 または Office 365 ProPlus のドキュメントに関するフィードバックを提供するには、ページの下部にある <strong>[このページは役立ちましたか?]</strong> リンクを選択します。ドキュメント チームにフィードバックが直接送信されます。</p>
